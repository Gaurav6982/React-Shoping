...
export default class Cart extends Component {
    ...
    render() {
        return (
            <div>
                {this.props.cartItems.length===0?(<div className="cart cart-header">
                    Cart is Empty.
                </div>) :
                ...
                <div>
                    ...
                    {this.props.cartItems.length!==0 && (
                        ...
                        <div className="cart">
                            <div className="total">
                                <div>Total:{" "}{formatCurrency(this.props.cartItems.reduce((a,c)=>a+c.price*c.count,0))}</div>
                                <button onClick={()=>this.setState({showForm:true})} className="button primary">Proceed</button>
                            </div>
                        </div>
                        {this.state.showForm && (
                            <div className="cart">
